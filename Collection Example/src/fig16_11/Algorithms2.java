...
public class Algorithms2 
{
   public static void main(String[] args) 
   {
      ...
      ArrayList<String> list2 = new ArrayList<>(); //a empty list to store another list's content
      ...
      Collections.addAll(list2, colors); // add colors Strings to list2 , like the append
