...
public class DisplayQueryResults extends JFrame 
{
   ...
   final static String DATABASE_URL = "jdbc:mysql://localhost:3307/member?serverTimezone=UTC";
   ...
   {   
      ...
      try 
      {
         ...
         JScrollPane scrollPane = new JScrollPane(queryArea, //好用ㄟ
         ...
         resultTable.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(e.getClickCount() == 2) {
					JOptionPane.showMessageDialog(null, tableModel.getValueAt(row, col));
				}
