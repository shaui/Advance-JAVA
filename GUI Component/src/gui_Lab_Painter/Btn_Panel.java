...
public class Btn_Panel extends JPanel{
	...
	private JButton last_step;
	
	//the button text
	private String[] btn_name = {"前景色","背景色","清除畫面","橡皮擦","上一步"};
	...
	public Btn_Panel()
	{
		...
		last_step = new JButton(btn_name[4]);
		...
		last_step.addActionListener(new LastStepListener());
	...
	private class BtnActionLis implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e) {
			...
			//check the eraser whether is using
			if(state == "橡皮擦") {
