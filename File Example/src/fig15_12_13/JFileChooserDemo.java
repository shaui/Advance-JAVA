...
public class JFileChooserDemo extends JFrame
{
   ...
   private Path getFileOrDirectoryPath()
   {
      ...
      int result = fileChooser.showOpenDialog(this); //represent the open or cancel choose
      ...
      return fileChooser.getSelectedFile().toPath(); //getSelectedFile return a File type data
   } 
