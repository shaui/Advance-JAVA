package fig15_9_SerializationApps;
...
public class ReadSequentialFile
{
   ...
   public static void readRecords()
   {
      ...
      try 
      {
         while (true) // loop until there is an EOFException --> When the file arrive the end
         {
        	//When read into this, it's Object class. So we should convert it to (Account) Object
