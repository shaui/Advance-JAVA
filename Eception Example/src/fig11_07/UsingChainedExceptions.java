...
public class UsingChainedExceptions
{
   ...
   public static void method2() throws Exception
   {
      ...
      {
         throw new Exception("Exception thrown in method2", exception); // "the second parameter represent that the "new Exception" is cause by "which Exception" "第二個參數是代表這個新的new的Exception是因為哪個Exception而造成的。
      } 
   } // end method method2
