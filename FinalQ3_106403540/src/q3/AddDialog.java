...
public class AddDialog extends JDialog{
	...
	public AddDialog() {
		...
		group.setPreferredSize(new Dimension(200,30));
		group.addItemListener(new TypeListener2());
	...
	public class TypeListener2 implements ItemListener{

		@Override
		public void itemStateChanged(ItemEvent e) {
			if(e.getStateChange() == ItemEvent.SELECTED) {
				typeStatus = (String)group.getSelectedItem();
				System.out.println(typeStatus);
			}
		}
	}
...
//				System.out.println(tempPhone);
			...
			if(nameStatus && phoneStatus) {
				if(memberID.equals("")) {
					...
					membersDBMS.insertData(name.getText(), (String)type.getSelectedItem(), phone.getText(), (String)group.getSelectedItem());
				}
				else {
					System.out.println("update");
					membersDBMS.updateData(memberID, name.getText(), (String)type.getSelectedItem(), phone.getText(), (String)group.getSelectedItem());
				}
				dispose();
			}
			else {
