...
public class FindPrimes extends JFrame 
{
   ...
   private PrimeCalculator calculator; //SwingWorker
         ...
         new ActionListener()
         {
            public void actionPerformed(ActionEvent e)
            {
               ...
               calculator = new PrimeCalculator(number, 
                  ...
                  cancelJButton, progressJProgressBar);

               // listen for progress bar property changes //用來更新進度條
...
//                        if (e.getPropertyName().equals("progress")) //若是對ProgressBar做修改，那event的名稱就是progress
//                        {
