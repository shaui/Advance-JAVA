package fig17_09_16; //Line:100、118 -> groupingBy(). Line:61 -> comparing().thenComparing().reversed() // Comparator.reverseOrder()
...
public class ProcessingEmployees
{
   public static void main(String[] args)
   {
      ...
      // Predicate(Interface) that returns true for salaries in the range $4000-$6000
      ...
      list.stream()
          ...
          .distinct()
          .sorted()
          //若要印顛倒的sorted( Comparator.reverseOrder() )
          .forEach(System.out::println);
