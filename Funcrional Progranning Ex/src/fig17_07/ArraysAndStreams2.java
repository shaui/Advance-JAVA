   ...
   public static void main(String[] args)
   {
      ...
      System.out.printf("strings greater than m sorted ascending: %s%n",
         Arrays.stream(strings)
               ...
               //CASE_INSENSITIVE_ORDER use the compareToIgnoreCase. 用法 : String.comparator //It isn't a method why it can do the sorted
               .collect(Collectors.toList()));
      ...
      System.out.printf("strings greater than m sorted descending: %s%n",
         Arrays.stream(strings)
               .filter(s -> s.compareToIgnoreCase("m") > 0)
               .sorted(String.CASE_INSENSITIVE_ORDER.reversed()) // 用法 : String.comparator.reversed()
               .collect(Collectors.toList()));
   }
